    ...
    <div class="container-fluid">
        ...
        <div class="row mb-2">
            ...
            <div class="col d-flex justify-content-end me-4">
                <button type="button" onclick="DeleteProduct()" class="btn btn-danger me-3" id="delete-product"
                    disabled>Delete Product</button>
                                            ...
                                            <form id="stepone" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div id="manufacturer-div">
                                                    <div class="row mb-4">
                                                        ...
                                                        <label for="horizontal-firstname-input" name="product_id"
                                                            class="bar-code col-sm-1 col-form-label d-flex justify-content-end">Bar
                                                            Code:</label>
                                                        <div class="col-sm-5">
                                                            <input type="text" name="code" id="code"
                                                                value="" class="form-control code" placeholder="code"
                                                                readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                    ...
                    <form id="filter-data" method="POST" enctype="multipart/form-data">
                        <div class="card">
                            <div class="row my-4">
                                ...
                                <label for="product_id" class="col-sm-1 col-form-label d-flex justify-content-end">Product
                                    ID:</label>
                                <div class="col-sm-2">
                                    <input type="text" name="product_id" id="product_id" class="form-control"
                                        placeholder="Product ID">
                                </div>
                                <label for="vendor_id" class="col-sm-1 col-form-label d-flex justify-content-end">Vendor
                                    ID:</label>
                                <div class="col-sm-2">
                                    <input type="text" value="" id="vendor_id" name="vendor_id"
