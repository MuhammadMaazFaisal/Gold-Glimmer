                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <select required="" name="purity"
                                                                ...
                                                                data-purity="{{ $product->purity_text }}" required>
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-5">
                                                            <input type="date" name="date[]" id="s_date"
                                                                value="{{ $stoneSetterStep->date }}" class="form-control"
                                                                placeholder="Date">
                                                        </div>
                                                        <label for="horizontal-firstname-input"
                                                            class="col-sm-1 col-form-label d-flex justify-content-end">Image
                                                    ...
                                                    <div class="row mb-4">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="number" step="any" name="s_total_weight[]"
                                                                ...
                                                                class="form-control" placeholder="Total Weight" readonly>
                                                        </div>
                                                        <label for="horizontal-firstname-input"
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="number" step="any" name="Issued_weight[]"
                                                                ...
                                                                class="form-control" placeholder="Issued Weight" readonly>
                                                        </div>
                                                    </div>
                                                    <div class="row mb-4">
                                                        <h5>Zircon:</h6>
                                                            ...
                                                            <div class="row mb-4">
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <input type="number" step="any"
                                                                        ...
                                                                        value="{{ $stone->weight }}" class="form-control"
                                                                ...
                                                                <div class="col-sm-2">
                                                                    <input type="number" name="stone_quantity[]"
                                                                        ...
                                                                        class="form-control" placeholder="Stone Quantity">
                                                                </div>
                                                                <div class="col-sm-2">
                                                                    @if ($loop->first)
                                            ...
                                            <form id="stepthree" method="POST" enctype="multipart/form-data">
                                                ...
                                                <div class="row mb-4">
                                                    <h5>Zircon:</h6>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <select name="zircon_code[]" id="zircon_code[]"
                                                                value="" class="form-control" placeholder="Zircon">
                                                    ...
                                                    <table class="table table-bordered" id="additionalTable">
                                                        ...
                                                        @else
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <select required="" id="a_type[]"
                                                                        name="type[]" class="form-control form-select">
                                                                        <option value="">Select Type</option>
                        ...
                        <tbody id="product-table-body">
                            ...
                            @foreach ($orders->orderDetails as $order)
                                <tr>
                                    ...
                                    <td>{{ $orders->date }}</td>
                                    <td>
                                        <a href="{{ route('product.edit', $order->p_id) }}"
